...
public class ActualizarUsuario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        System.out.println("Iniciando proceso de actualizacion de usuario");
        ...
        boolean modificado = controlDbUsuarios.actualizarUsuario(nombreUsuario, nombreCompleto, contrasenia, Integer.parseInt(tipoUsuario));
