<%-- 
    Document   : index.jsp
    Created on : 14/10/2021, 07:08:15 PM
    Author     : willi
--%>
...
<body id="page-top" data-bs-spy="scroll" data-bs-target="#mainNav" data-bs-offset="77">
    ...
    <header class="masthead" style="background-image:url('assets/img/introd.jpg');">
        <div class="intro-body">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 mx-auto">
                        <h4 class="brand-heading">&nbsp&nbspAgenda &nbsplunar </h4>
                        <h4>&nbspPorque las siembras siempre han estado conectadas a las estrellas...</h4>
                        <p class="intro-text"></p><a class="btn btn-link btn-circle" role="button" href="#titulo_luna"><i class="fa fa-angle-double-down animated"></i></a>
                    </div>
                </div>
            </div>
        </div>
    </header>
    <section class="text-center" id="titulo_luna"  >
            <h1>&nbsp</h1>
            <h1>Agenda Lunar</h1>
            <p>&nbsp;Ingresar a la cuenta</p>
            <button class="btn btn-primary btn-lg btn-default" href="login.html" type="submit">Ingresar</button>
        
    </section>
    <section class="text-center download-section content-section" id="about" style="background-image:url('assets/img/downloads-bg.jpg');" >
        <div class="container">
                <div class="">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto">
                    ...
                    <ul class="list-inline banner-social-buttons">
                        ...
                        <li class="list-inline-item">&nbsp;<button target="google.com" class="btn btn-primary btn-lg btn-default" type="button"><i class="fa fa-github fa-fw"></i><span class="network-name">&nbsp;github</span></button></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <footer>
        <div class="container text-center">
            <p>Copyright ©&nbsp;AgendaLunar 2021</p>
        </div>
    </footer>
